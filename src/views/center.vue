  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='shangjia'"  label='商家类型' prop="shangjiaTypes">
                 <el-select v-model="ruleForm.shangjiaTypes"  placeholder='请选择商家类型'>
                     <el-option
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='账号状态' prop="statusTypes">
                 <el-select v-model="ruleForm.statusTypes"  placeholder='请选择账号状态'>
                     <el-option
