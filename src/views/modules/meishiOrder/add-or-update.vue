        ...
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='meishi'">
                    <el-form-item class="select" v-if="type!='info'"  label="美食" prop="meishiId">
                        <el-select v-model="ruleForm.meishiId" :disabled="ro.meishiId" filterable placeholder="请选择美食" @change="meishiChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='meishi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="美食名称" prop="meishiName">
                        <el-input v-model="meishiForm.meishiName"
                                  placeholder="美食名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12" v-if="sessionTable !='meishi' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.meishiPhoto" label="美食照片" prop="meishiPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (meishiForm.meishiPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='meishi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="美食类型" prop="meishiValue">
                        <el-input v-model="meishiForm.meishiValue"
                                  placeholder="美食类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单号" prop="meishiOrderUuidNumber">
                       <el-input v-model="ruleForm.meishiOrderUuidNumber"
                                 placeholder="订单号" clearable  :readonly="ro.meishiOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单号" prop="meishiOrderUuidNumber">
                           <el-input v-model="ruleForm.meishiOrderUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="预定时间" prop="meishiOrderTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.meishiOrderTime" label="预定时间" prop="meishiOrderTime">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实付价格" prop="meishiOrderTruePrice">
                       <el-input v-model="ruleForm.meishiOrderTruePrice"
                                 placeholder="实付价格" clearable  :readonly="ro.meishiOrderTruePrice"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="实付价格" prop="meishiOrderTruePrice">
                           <el-input v-model="ruleForm.meishiOrderTruePrice"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="快递公司" prop="meishiOrderCourierName">
                       <el-input v-model="ruleForm.meishiOrderCourierName"
                                 placeholder="快递公司" clearable  :readonly="ro.meishiOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="快递公司" prop="meishiOrderCourierName">
                           <el-input v-model="ruleForm.meishiOrderCourierName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单快递单号" prop="meishiOrderCourierNumber">
                       <el-input v-model="ruleForm.meishiOrderCourierNumber"
                                 placeholder="订单快递单号" clearable  :readonly="ro.meishiOrderCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单快递单号" prop="meishiOrderCourierNumber">
                           <el-input v-model="ruleForm.meishiOrderCourierNumber"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="meishiOrderTypes">
                        <el-select v-model="ruleForm.meishiOrderTypes" :disabled="ro.meishiOrderTypes" placeholder="请选择订单类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="订单类型" prop="meishiOrderValue">
                        <el-input v-model="ruleForm.meishiOrderValue"
                            placeholder="订单类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="支付类型" prop="meishiOrderPaymentTypes">
                        <el-select v-model="ruleForm.meishiOrderPaymentTypes" :disabled="ro.meishiOrderPaymentTypes" placeholder="请选择支付类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="支付类型" prop="meishiOrderPaymentValue">
                        <el-input v-model="ruleForm.meishiOrderPaymentValue"
