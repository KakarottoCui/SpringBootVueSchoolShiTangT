                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('yonghu','状态')" type="success" size="mini" @click="zhanghao(scope.row.id,scope.row.statusTypes)">{{scope.row.statusTypes == 1?'冻结账号':'取消冻结'}}</el-button>
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
			...
			zhanghao(id,types){
				...
				this.$confirm(`确定进行[${types==1? "冻结账号" : "取消冻结"}]操作?`, "提示", {
