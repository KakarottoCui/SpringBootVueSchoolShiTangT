<template>
    <div class="addEdit-block">
        <el-form
                ...
                >
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='meishi' && sessionTable != 'shangjia'">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="meishiCommentbackText">
                        <el-input type="textarea"  :readonly="ro.meishiCommentbackText" v-model="ruleForm.meishiCommentbackText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.meishiCommentbackText" label="评价内容" prop="meishiCommentbackText">
