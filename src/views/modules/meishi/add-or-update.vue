        ...
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='shitang'">
                    <el-form-item class="select" v-if="type!='info'"  label="食堂" prop="shitangId">
                        <el-select v-model="ruleForm.shitangId" :disabled="ro.shitangId" filterable placeholder="请选择食堂" @change="shitangChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='shitang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="食堂编号" prop="shitangUuidNumber">
                        <el-input v-model="shitangForm.shitangUuidNumber"
                                  placeholder="食堂编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="食堂编号" prop="shitangUuidNumber">
                            <el-input v-model="ruleForm.shitangUuidNumber"
                                      placeholder="食堂编号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='shitang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="食堂名称" prop="shitangName">
                        <el-input v-model="shitangForm.shitangName"
                                  placeholder="食堂名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="食堂名称" prop="shitangName">
                            <el-input v-model="ruleForm.shitangName"
                                      placeholder="食堂名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="sessionTable !='shitang' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shitangPhoto" label="食堂照片" prop="shitangPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (shitangForm.shitangPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shitangPhoto" label="食堂照片" prop="shitangPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.shitangPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='shitang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="食堂类型" prop="shitangValue">
                        <el-input v-model="shitangForm.shitangValue"
                                  placeholder="食堂类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="食堂类型" prop="shitangValue">
                            <el-input v-model="ruleForm.shitangValue"
                                      placeholder="食堂类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='shitang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="食堂地址" prop="shitangAdd">
                        <el-input v-model="shitangForm.shitangAdd"
                                  placeholder="食堂地址" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="食堂地址" prop="shitangAdd">
                            <el-input v-model="ruleForm.shitangAdd"
                                      placeholder="食堂地址" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='shitang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="食堂热度" prop="shitangClicknum">
                        <el-input v-model="shitangForm.shitangClicknum"
                                  placeholder="食堂热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="食堂热度" prop="shitangClicknum">
                            <el-input v-model="ruleForm.shitangClicknum"
                                      placeholder="食堂热度" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <input id="updateId" name="id" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="美食编号" prop="meishiUuidNumber">
                       <el-input v-model="ruleForm.meishiUuidNumber"
                                 placeholder="美食编号" clearable  :readonly="ro.meishiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="美食编号" prop="meishiUuidNumber">
                           <el-input v-model="ruleForm.meishiUuidNumber"
                                     placeholder="美食编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.meishiPhoto" label="美食照片" prop="meishiPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.meishiPhoto?$base.url+ruleForm.meishiPhoto:''"
                            @change="meishiPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.meishiPhoto" label="美食照片" prop="meishiPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.meishiPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.meishiContent = _this.ruleForm.meishiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.meishiContent = this.ruleForm.meishiContent.replaceAll(this.$base.url,"");
                        this.$http({
