            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='meishi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="美食编号" prop="meishiUuidNumber">
                        <el-input v-model="meishiForm.meishiUuidNumber"
                                  placeholder="美食编号" clearable readonly></el-input>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='meishi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="美食库存" prop="meishiKucunNumber">
                        <el-input v-model="meishiForm.meishiKucunNumber"
                                  placeholder="美食库存" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='meishi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="美食原价" prop="meishiOldMoney">
                        <el-input v-model="meishiForm.meishiOldMoney"
                                  placeholder="美食原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='meishi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="美食热度" prop="meishiClicknum">
                        <el-input v-model="meishiForm.meishiClicknum"
                                  placeholder="美食热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="美食热度" prop="meishiClicknum">
                            <el-input v-model="ruleForm.meishiClicknum"
                                      placeholder="美食热度" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="账号状态" prop="statusValue">
                        <el-input v-model="yonghuForm.statusValue"
                                  placeholder="账号状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="账号状态" prop="statusValue">
                            <el-input v-model="ruleForm.statusValue"
                                      placeholder="账号状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
